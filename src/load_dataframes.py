...
def demo_dataframes(frames, names):
...
for frame_name, fname_h5 in frame_names.items():
    # Read the data frame
...
demo_frames = [frames['Artist'], frames['Album']]
demo_names = ['Artist', 'Album']

# Demo dataframes
print('')
demo_dataframes(demo_frames, demo_names)
